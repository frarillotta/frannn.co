...
export const roles: Roles[] = [
    {
      ...
      children: <>
        ...
        <p>
          Our stack was a typical modern Javascript stack: Typescript for static types, Jest and Cypress to test our entire codebase (with a minimum coverage of 95%); React, Redux, Webpack and Material-UI for our UIs; Node.js, AWS (EKS, S3, CloudFront), Datadog, Kafka, MongoDB, Kubernetes, and CQRS architecture for our backend.
        </p>
        <br/>  
        <p>
        ...
        <p> 
          Aside from day-to-day development, my work was focused on the full stack of our tech: from client-side code to our backend. On the client-side front I focused on our engagement data collection, which handles more than 1.5 billion requests each day globally. I improved the quality of those metrics by using modern APIs and running constant experiments, which resulted in their accuracy getting closer to the leading adtech platforms (namely, Google, Facebook, The Trade Desk, etc.).
        </p>
        <p>  
          On the React+Redux front I took many initiatives to improve the performance of our UIs, while on the backend side, I took part in the re-work of our whole infrastructure, helping with design, architecture, documentation and benchmarking.
        </p>
      </>,
      ...
      children: <>
        ...
        <p> 
          Under the leadership and mentorship of our founder, I got to work on many exciting projects, using quick iteration cycles with fast feedback loops, hacking the concept of lean development. My role was to reduce asymmetric information between where we wanted our product to go and what the industry response would be, by developing MVPs and POCs and evaluating the results with a data-driven approach.
        </p>
        <p> 
          This was definitely my most formative role yet: I got to work on entire product lines from conception and market research, all the way through architecting the solution (usually full stack), building it, implementing it, proving its value to the business and wrapping up with, together with our marketing team, building a go-to-market strategy and long-term plan for the product.
        </p>
        <p>
          There are many interesting projects I got to work on: a monetization tool for adblock users that respects their privacy and their browsing experience, a content recommendation tool based on collaborative filtering using K-nearest neighbour fueled by our first party user engagement data, a machine-learning yield optimization tool, many improvements to our existing revenue-generating products, 3rd party data integrations with global top publishers (including CNN, Reach and Future).
        </p>
      </>,    
      ...
      children: <>
        ...
        <p> 
          During this time I worked with many <Anchor style={{fontWeight: "bold"}} href="https://www.comscore.com/Insights/Rankings">Comscore 50</Anchor> publishers, ensuring their implementation experience was smooth and troubleshooting cases were resolved as quickly and efficiently as possible, but also proactively running analysis (automated and manual) to catch any unseen issues.
        </p>
      </>,     
      ...
      children: <>
        ...
        <br/>
        <p>
          While I had some work experience before this, Sovrn was my very first tech job out of university, where I got a degree in economics.
        </p> 
        <p> 
        ...
        <p>
          ...
          During my time in this role I focused on assisting online publishers in monetizing their traffic with data analysis, brand safety audits, implementation and troubleshooting; I embodied Sovrn's mission and made it my mission.
        </p>
        <p>
